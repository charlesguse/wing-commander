...
```json
{"type":"object","properties":{"specified":{"type":"boolean"},"clarifications":{"type":"array","items":{"type":"object","properties":{"question":{"type":"string"},"context":{"type":["string","null"]},"options":{"type":"array","items":{"type":"object","properties":{"answer":{"type":"string"},"implications":{"type":["string","null"]}},"required":["answer"]}}},"required":["question"]}},"findings":{"type":"array","items":{"type":"object","properties":{"title":{"type":"string"},"what":{"type":"string"},"evidence":{"type":"object","properties":{"file_paths":{"type":"array","items":{"type":"string"}},"detail":{"type":"string"}},"required":["file_paths"],"additionalProperties":false},"fingerprint_basis":{"type":"object","properties":{"file_path":{"type":"string"},"gate_or_artifact":{"type":"string"}},"required":["file_path","gate_or_artifact"],"additionalProperties":false}},"required":["title","what","evidence","fingerprint_basis"],"additionalProperties":false}}},"required":["specified","clarifications"]}
```
