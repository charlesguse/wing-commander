...
- [ ] T002 [US1] Rewrite "Read back cycle outcome"'s `run:` block in `.github/workflows/implement.yml` (lines 878-926) per research.md D1-D4 and contracts/implement-cycle-outcome.md's `outcome` section:
...
- [ ] T012 [P] [US5] Extend `.github/scripts/verify-truncated-cycle-carry-forward.py` with contracts/truncated-cycle-coverage.md's "Additional assertions":
